---
description: Run technique coverage check and report gaps against MITRE scope
---
...
1. Ask the user: 
   - Which scope — Scenario 1 (Crimeware) or Scenario 2 (PRC Espionage)?
   - Which folder or Phase files to check?
