...
- The Calibrated label is **independent of ACW**. A technique's importance in the chain (Critical/High/Medium/Low) never makes a row more or less scoreable — judge calibration only on observability/reproducibility/verifiability.
