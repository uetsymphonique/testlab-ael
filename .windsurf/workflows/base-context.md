---
description: Load base project context for ATT&CK adversary emulation planning
---
 
# Base Context — Adversary Emulation Planning
 
Load this workflow to establish project context before working on emulation plans.
