...
Ideal for: EDR platforms, SIEM integrations, endpoint protection vendors, managed services focused on host-based security
...
- [x] T1112 - Modify Registry  <!-- plan tactic: Defense Evasion -->
- [ ] ~~T1133 - External Remote Services~~
