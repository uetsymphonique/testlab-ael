...
| `staging.html` + `Essos_Compliance_Update.txt` | HTML-smuggled polyglot launcher (client-side `.txt` assembly → Win+R PowerShell decode → `%TEMP%` HTA) - Step 1C | WS01 |
