...
del /f /q "C:\Users\labuser\AppData\Local\Temp\hpsolutionsportal.hta" 2>nul
...
> `g.dmp` (plaintext MDMP dump), `pid_out.txt` (tasklist CSV) and `acl_out.txt` (icacls output) are SYSTEM-owned.
...
del /f "C:\Users\labuser\AppData\Local\Temp\hpsolutionsportal.hta"
...
| IIS01 | No dump/temp files | `dir C:\ProgramData\DF*.tmp C:\ProgramData\g.dmp C:\ProgramData\pid_out.txt C:\ProgramData\acl_out.txt C:\ProgramData\*.cmd C:\ProgramData\rdump_out.txt C:\ProgramData\sys_out.txt C:\ProgramData\fwp_out.txt C:\ProgramData\fwp_rev.txt C:\ProgramData\*.stl` |
