...
**Source:** `resources/payloads/dnscat2/go-client/`
...
**Output:** `resources/payloads/dnscat2/go-client/svcmgr.exe`
...
**Source:** `resources/payloads/EfsPotato/`
...
**Source:** `resources/payloads/CWLHerpaderping/`
...
**Source:** `resources/payloads/LsassReflectDumping/ReflectDump/`
...
```cmd
cd resources\payloads\LsassReflectDumping\ReflectDump
...
python compress_payload.py ../LsassReflectDumping/ReflectDump/x64/Release/ReflectDump.exe -o wdhelper.gz -l 9
```
...
**Source:** `resources/payloads/go-thehash/`
...
**Source:** `resources/payloads/windows-service/advapi32-cpp/`
...
**Source:** `resources/payloads/windows-service/syscalls-cpp/`
...
**Source:** `resources/payloads/NtdsRawDump/NtdsRawDump.cs`
...
**Output:** `resources/payloads/NtdsRawDump/PolicySyncSvc.exe`
...
**Source:** `resources/payloads/ImpactPayload/`
