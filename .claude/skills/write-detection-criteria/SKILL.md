...
**"These rows are setup / Generic Operational Behavior - I'll skip them."** Coverage is every row. A skipped row has no evidence base, forcing `assign-category` back into imagining criteria - exactly the hallucination this ordering was built to remove.
