...
2. Map from the knowledge base, not from memory — open the relevant `mitre-knowledge-base/techniques/<tactic>.md` and confirm the ID and sub-technique before writing it.
